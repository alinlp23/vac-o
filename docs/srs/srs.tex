...
\section{Requerimientos}
  ...
  \begin{enumerate}
    ...
    El sistema solicita a la extensi\'on cargada en memoria, las regiones combinatorias de interes para la optimizaci\'on. La extensi\'on debe devolver las regiones (\textit{[(inicio, fin, tipo)]}) y el sistema inicializa cada region en memoria. 
